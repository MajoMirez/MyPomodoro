...
public class MyPref3_Long {

    private static String keyValueTest = "long_time";
    ...
    public static int getValueTest(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context).getInt(keyValueTest, 15);
    }
